...
#for section in sections:
#  print "Dumping", section
#  dump_stories(top_stories, section, "temp")  
end  = time()
print start, end, end - start
fname = strftime("%H-%M-%S.gn.dmp", localtime())
print fname
pickle.dump(top_stories, open(fname, "w"))
# soup.table.tbody.tr.td.div.div.div.findAll('div', { 'class' : 'section-content'} )

#soup.findAll('td', { 'class' : 'esc-layout-article-cell'})
